...
/*
Database mamanger class, responsible for handling the connection and querying the database 
...
class DBManager
{
	...
	//quries database and allows or returning of rows, mainly use for selects
