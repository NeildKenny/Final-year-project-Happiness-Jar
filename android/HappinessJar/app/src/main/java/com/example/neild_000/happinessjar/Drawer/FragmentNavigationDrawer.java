package com.example.neild_000.happinessjar.Drawer;
...
* https://gist.github.com/nidhi1608/104b31cb0ebc1f7b3f69#file-fragmentnavigationdrawer-java
*/
...
public class FragmentNavigationDrawer extends DrawerLayout {
    ...
    public void setupDrawerConfiguration(ListView drawerListView, Toolbar drawerToolbar, int drawerItemRes, int drawerContainerRes) {
       ...
       // getSupportActionBar().setBackgroundDrawable(new ColorDrawable(0xffa414d7));
